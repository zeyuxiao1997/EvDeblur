...
parser.add_argument("--input_path", default="/data/liyao/ColorNerf/eventdeblur/GOPRO/test/", help="Path to hdf5 file")
parser.add_argument("--save_path", default="/data/liyao/ColorNerf/eventdeblur/GOPRO_SCER/test/")
